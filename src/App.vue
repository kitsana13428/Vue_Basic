<template>
  <section>
    ...
    <article v-show="isVisble">
      ...
      <p>ตัวเลข :</p>
      <!--การใช้งานอาเรย์-->
      <p v-if="number.length === 0">ไม่มีงานอดิเรก</p>
      <div v-else>
        <p>งานอดิเรก :</p>
      ...
      <button @click="incerment(10)">เพิ่ม</button>
      <!--การเพิ่มค่าด้วย on click-->
